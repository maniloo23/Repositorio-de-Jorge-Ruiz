...
void main(void)
{
char *cad0 = "Buenos días"; /* En este caso se asignan 11 caracteres más elcaracter de terminación ‘\0’ a la posición de memoria a la que apunta lavariable cad0 —apuntador del tipo cadena de caracteres. */
char cad1[20] = "Hola"; /* Se asignan cuatro caracteres más el caracterde terminación a la variable tipo char cad1. Observa que cad1 tiene espaciopara 20 caracteres.*/
...
printf("\nLa cadena cad0 es: ");
puts(cad0);/* La función puts es la más apropiada para escribir cadenas de caracteres.
...
ello esta función únicamente es útil si conocemos con anticipación que la/cadena que vamos a leer está formada por una sola palabra. */
printf("\nLa cadena cad5 es: ");
printf("%s", cad5);
fflush(stdin);
char p;
