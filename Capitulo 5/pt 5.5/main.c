...
El programa, al recibir como datos las calificaciones de un grupo de 50 alumnso, obtiene la frecuencia de cada una de las calificaciones y ademas escribe cual es la frecuencia mas alta */

const int TAM = 50;

void Lectura(int *, int);
void Frecuencia(int , int, int , int);       /*Prototipos de funcion*/
void Impresion(int *, int);
void Mayor(int *, int);

void main(void)
{
    int CAL[TAM], FRE[6] = {0};                 /*Declaracion de arreglos*/
    Lectura(CAL, TAM);                          /*Se llama a la funcino Lectura */
...
void Lectura(int VEC[], int T)                     /*La funcion Lectura se utiliza para leer el arreglo de calificaciones */
{
    ...
    void Mayor(int *, int T)                                /* Esta funcion obtiene la primera ocurrencia de la frecuencia mas alta*/
    {
